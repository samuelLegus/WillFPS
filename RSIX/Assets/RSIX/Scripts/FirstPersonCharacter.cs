...
public class FirstPersonCharacter : MonoBehaviour
{
	...
	[SerializeField] private float strafeSpeed = 3f;                                    // The speed at which we want the character to be able to strafe
	...
	[SerializeField] private float walkSpeed = 4f;                                      // The speed at which we want the character to move
#endif
	...
	public void FixedUpdate ()
	{
		...
		bool walkOrRun =  Input.GetKey(KeyCode.Mouse1);
		bool step = Input.GetKey(KeyCode.LeftShift);
